...
Skills pessoais para agentes de IA (Claude Code e compatíveis).
...
- [`skills/db-query`](skills/db-query/SKILL.md) — roda SQL em qualquer banco MySQL/MariaDB configurado (ex: Brumi na Hostinger), escolhido por nome via `--db`.
